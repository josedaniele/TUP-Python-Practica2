...
def combinar_basico(nombres: List[str], precios: List[float]) -> Tuple[Any]:
    ...
    Restricción:
        ...
        - Utilizar índices.
    """
    nada = tuple((nombre_articulos[i],precio_articulos[i])for i in range(0,len(nombre_articulos)))
    return(nada)
# NO MODIFICAR - INICIO
respuesta = (
    ("ventana", 100.48),
...
def combinar_enumerate(nombres: List[str], precios: List[float], ids: List[int]) -> Tuple[Any]:  # noqa: E501
    ...
    """
    nada = tuple((nombre_articulos[i],precio_articulos[i],id_articulos[i])for i , x in enumerate(nombre_articulos))
    return(nada)
...
def combinar_zip(nombres: List[str], precios: List[float], ids: List[int]) -> Tuple[Any]:  # noqa: E501
    ...
    """
    nada = tuple(zip(nombre_articulos,precio_articulos,id_articulos))
    return(nada)
# NO MODIFICAR - INICIO
respuesta = (
    ("ventana", 100.48, 6852),
